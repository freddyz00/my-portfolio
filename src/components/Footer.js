    ...
    <footer className="bg-[#4ADE72] py-8">
      <div className="container mx-auto flex items-center justify-center">
        <a
          ...
          target="_blank"
        >
          <div className="group mx-3 rounded-full w-12 h-12 bg-[#4ADE72] grid place-items-center border border-white border-solid cursor-pointer hover:bg-white transition">
            <FaDiscord className="text-2xl text-white group-hover:text-[#4ADE72]" />
          </div>
        </a>
        <a href="https://www.linkedin.com/in/htet-naing-aung/" target="_blank">
          <div className="group mx-3 rounded-full w-12 h-12 bg-[#4ADE72] grid place-items-center border border-white border-solid cursor-pointer hover:bg-white transition">
            <FaLinkedinIn className="text-2xl text-white group-hover:text-[#4ADE72]" />
          </div>
        </a>
        <a href="https://github.com/freddyz00" target="_blank">
          <div className="group mx-3 rounded-full w-12 h-12 bg-[#4ADE72] grid place-items-center border border-white border-solid cursor-pointer hover:bg-white transition">
            <FaGithub className="text-2xl text-white group-hover:text-[#4ADE72]" />
          </div>
        </a>
        <a href="mailto:freddyzhao.2000@gmail.com">
          <div className="group mx-3 rounded-full w-12 h-12 bg-[#4ADE72] grid place-items-center border border-white border-solid cursor-pointer hover:bg-white transition">
